// --- src/app/components/ProjectsGrid.js (new) ---
"use client";
...
function Thumb({ src, alt }) {
  if (src?.endsWith(".mp4")) {
    return (
      <video className="card-thumb" src={src} autoPlay muted loop playsInline />
    );
  }
  return (
    <Image src={src} alt={alt} width={1200} height={675} className="card-thumb" />
  );
}
