...
export default function Home() {
  ...
  return (
    <div className="text-fg">
      {/* Education — diamond bullet; EE + logo + bold University */}
      <div className="section-line">
        <span className="inline-logo">
          ...
          <Link href="https://www.mcmaster.ca/" target="_blank" className="u-anim font-semibold">
            McMaster University
          </Link>
        </span>
      </div>

      {/* what i’ve been building — arrow rows; only linked part bold/animated */}
      <div className="mt-4">
        ...
        <ul className="mt-2 grid gap-2">
          <li className="li-row">
            ...
            <Link href="https://github.com/chaffybird56/PCBSolderRobot" target="_blank" className="u-anim font-semibold">
          ...
          <li className="li-row">
            ...
            <Link href="https://github.com/chaffybird56/Home-EnergyMonitor" target="_blank" className="u-anim font-semibold">
      ...
      {/* Signature block ABOVE projects 
      <div className="mt-8">
